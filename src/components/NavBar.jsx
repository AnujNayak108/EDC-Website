...
//mport { FaAutoprefixer } from "react-icons/fa";
...
const NavBar = () => {
    ...
    return (
        <nav>
            <div className="h-10vh flex justify-between z-50 text-white lg:py-1 px-20 py-1 border-b border-slate-800 fixed top-0 left-0 w-screen transparent backdrop-blur-[1px] lg:gap-0 gap-8 ">
